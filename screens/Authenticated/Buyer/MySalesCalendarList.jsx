...
import SalesCalendarItem from "../../../components/SalesCalendarItem";

const MySalesCalendarList = ({ navigation }) => {
        ...
        <View style={styles.layout}>
            ...
            <View style={styles.topBar}>
                <View style={styles.topBarItems}>
                    ...
                    <Text style={styles.titleTxt}>My List</Text>
...
export default MySalesCalendarList;
