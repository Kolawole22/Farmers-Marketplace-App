        ...
        <View style={{ flex: 1 }}>
          <View style={styles.register}>
            ...
            <Text style={styles.parag}>
              You are at the right place, choose the best sect that describes
              you{" "}
            </Text>
          </View>
          <ScrollView style={{}}>
              ...
              <View style={styles.viewForm}>
                ...
                <View style={{ marginTop: 24 }}>
                  <Input
                    ...
                    onChangeText={(text) =>
                      setValues({ ...values, community: text })
                    }
                  />
                </View>
