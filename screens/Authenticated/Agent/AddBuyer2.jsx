...
const AddBuyer2 = ({ navigation, route }) => {
  ...
  const confirmInterests = async () => {
    ...
    if (buyerInterests.length < 1) {
      ...
      axios
        .patch(
          `${BACKEND_URL}/accounts/customer_registration/${buyerId}/update_interests/`,
          data
        )
        .then((res) => {
