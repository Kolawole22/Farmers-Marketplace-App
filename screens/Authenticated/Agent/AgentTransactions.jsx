...
import { agentTransactions } from "../../../components/constants/slides";
import AgentTransactionCard from "../../../components/AgentTransactionCard";
import Empty from "../../../components/Empty";

const AgentTransactions = ({ navigation }) => {
            ...
            <SafeAreaView style={styles.safeContainer}>
                ...
                >
                    <View style={styles.transactionsView} >
                        {
                            agentTransactions ? agentTransactions.map((item) => (
                                <AgentTransactionCard key={item.id } data={item} />
                            )) : (
                                    <Empty text="No Transactions" subtext="Your Transactions will show here" />
                            )
                        }
                    </View>
                </ScrollView>
