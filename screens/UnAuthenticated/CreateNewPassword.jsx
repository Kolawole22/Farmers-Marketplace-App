...
const CreateNewPassword = ({ navigation }) => {
  ...
  const fetchData = async () => {
    const savedData = await AsyncStorage.getItem("FarmerSignupData");

    if (savedData !== null) {
      //   console.log("Retrieved farmer data", savedData);
      setRetrievedFarmerData(JSON.parse(savedData));
    } else {
      console.log("No farmer data exists");
    }
  };
