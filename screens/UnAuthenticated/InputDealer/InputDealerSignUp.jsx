...
const InputDealerSignUp = ({ navigation }) => {
  ...
  const registerInputDealer = async () => {
    setLoading(true);
    ...
    if (
      ...
      axios
        .post(`${BACKEND_URL}/accounts/register/input-dealer/`, data)
        .then((res) => {
          console.log("farmer signup response:::", res.data);
          if (res.status === 200 || res.status === 201) {
            setLoading(false);
            navigation.navigate("InputDealerSignUp2");
            setToastValues({
              ...toastValues,
              show: true,
              type: "Success",
    ...
    >
      ...
      >
        <View style={styles.register}>
          ...
          <Text style={styles.parag}>Create an account as an Input Dealer</Text>
          <Text>OR</Text>
          <TouchableOpacity
            onPress={() => navigation.navigate("InputDealerSignIn")}
...
export default InputDealerSignUp;
